            ...
            <table style="width:100%; padding:5px;" border="0" cellpadding="5" cellspacing="0">
                <tr>
                    ...
                    <td style="width:85%; text-align:left">
                        <asp:TextBox ID="txtServerUrl" runat="server" Width="90%"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td align="left">前置执行协议ID：</td>
                    <td align="left">
                       <asp:TextBox ID="txtMoreContrats" runat="server" Width="90%"></asp:TextBox>(多个以,分隔)
                    </td>
                </tr>
                <tr>
                    <td align="left">协议ID：</td>
                    <td align="left">
                        <asp:DropDownList ID="ddlContract" runat="server" Width="90%" 
                ...
                <tr>
                    <td align="left">参数：</td>
                    <td align="left">
                        <asp:TextBox ID="ParamListTextBox" runat="server" Width="90%"></asp:TextBox>(多个以,分隔)
                    </td>
                </tr>
                <tr>
                    <td align="left">PassportID：</td>
                    <td align="left">
                        <asp:TextBox ID="txtPassport" runat="server" Width="90%"></asp:TextBox>(必填)
                    </td>
                </tr>
                <tr>
                    <td align="left">Password：</td>
                    <td align="left">
                        <asp:TextBox ID="txtPassword" runat="server" Width="90%"></asp:TextBox>(必填)
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td align="left">
                        <asp:Button ID="btnTest" runat="server" Text="测试" Width="100px" onclick="btnTest_Click"/>
                        &nbsp;&nbsp;
