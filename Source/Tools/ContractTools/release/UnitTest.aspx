<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnitTest.aspx.cs" Inherits="ContractTools.WebApp.UnitTest" %>
            ...
            <table style="width:100%; padding:5px;" border="0" cellpadding="5" cellspacing="0">
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <td align="left">
                        <asp:TextBox ID="txtServerID" runat="server" Width="80%"></asp:TextBox>(非socket无视)
                    </td>
                </tr>
                <tr>
                    <td align="left">参数：</td>
