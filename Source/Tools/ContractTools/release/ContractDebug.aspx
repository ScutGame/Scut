...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <style type="text/css">
        .table{width: 100%;}
        .table span,.table input[type="text"],.table textarea { padding: 0 2px;}
    </style>
</head>
<body>
    ...
    <div style="padding: 10px 5px;">
        <table class="table">
            ...
            <tr>
                ...
                <td><asp:DropDownList ID="ddlContract" runat="server" Width="99%" AutoPostBack="True" onselectedindexchanged="OnContractSelectedIndexChanged"></asp:DropDownList></td>
            </tr>
            <tr>
                <td style="text-align: right; vertical-align: top;"><span>测试参数:</span></td>
                <td><asp:TextBox ID="txtParams" runat="server" Width="99%" Height="100px" TextMode="MultiLine"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="text-align: right;"><span>Sid:</span></td>
                <td><asp:TextBox ID="txtSid" runat="server" Width="99%" OnTextChanged="OnRefresh" AutoPostBack="True"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="text-align: right;"><span>Uid:</span></td>
                <td><asp:TextBox ID="txtUid" runat="server" Width="99%" Text="0" OnTextChanged="OnRefresh" AutoPostBack="True"></asp:TextBox></td>
            </tr>
            <tr>
