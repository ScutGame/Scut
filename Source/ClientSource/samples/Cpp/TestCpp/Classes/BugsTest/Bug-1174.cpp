...
int check_for_error( CCPoint p1, CCPoint p2, CCPoint p3, CCPoint p4, float s, float t )
{
    ...
    // Since float has rouScuting errors, only check if diff is < 0.05
...
//         sraScut(0);
        ...
        for( int i=0; i < 10000; i++)
        {
            ...
            // -----
            // c | d
            float ax = CCRAScutOM_0_1() * -5000;
            float ay = CCRAScutOM_0_1() * 5000;

            // a | b
            // -----
            // c | D
            float dx = CCRAScutOM_0_1() * 5000;
            float dy = CCRAScutOM_0_1() * -5000;

            // a | B
            // -----
            // c | d
            float bx = CCRAScutOM_0_1() * 5000;
            float by = CCRAScutOM_0_1() * 5000;
            
            // a | b
            // -----
            // C | d
            float cx = CCRAScutOM_0_1() * -5000;
            float cy = CCRAScutOM_0_1() * -5000;
        ...
        for( int i=0;i<10000;i++)
        {
            ...
            // -----
            // c | d
            float ax = CCRAScutOM_0_1() * -500;
            float ay = CCRAScutOM_0_1() * 500;
            p1 = ccp(ax,ay);
            
            // a | b
            // -----
            // c | D
            float dx = CCRAScutOM_0_1() * 500;
            float dy = CCRAScutOM_0_1() * -500;
            p2 = ccp(dx,dy);
            ...
            // -----
            // C | d
            float cx = CCRAScutOM_0_1() * -500;
            p3 = ccp(cx,y);
            
            // a | B
            // -----
            // c | d
            float bx = CCRAScutOM_0_1() * 500;
            p4 = ccp(bx,y);
