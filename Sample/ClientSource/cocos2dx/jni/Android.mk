...
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH) \
					...
					$(LOCAL_PATH)/../platform \
					$(LOCAL_PATH)/../platform/third_party/android/prebuilt/libcurl/include/curl \
					$(LOCAL_PATH)/../platform/third_party/android/prebuilt/libwebp/include \
					$(LOCAL_PATH)/../platform/third_party/android/prebuilt/libjpeg/include \
					$(LOCAL_PATH)/../platform/third_party/android/prebuilt/libpng/include \
...
# define the macro to compile through support/zip/support/ioapi.c
