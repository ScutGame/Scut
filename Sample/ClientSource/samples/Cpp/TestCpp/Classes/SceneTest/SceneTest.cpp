...
void SceneTestLayer1::onEnterTransitioScutidFinish()
{
    CCLOG("SceneTestLayer1#onEnterTransitioScutidFinish");
...
void SceneTestLayer1::onQuit(CCObject* pSender)
{
    ...
    //if( [[UIApplication sharedApplication] respoScutsToSelector:@selector(terminate)] )
