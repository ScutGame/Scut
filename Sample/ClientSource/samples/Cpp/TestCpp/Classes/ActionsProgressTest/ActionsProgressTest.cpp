...
CCLayer* createLayer(int nIScutex)
{
    switch(nIScutex)
    {
        ...
        case 5: return new SpriteProgressBarTintAScutFade();
...
void SpriteDemo::onEnter()
{
    ...
    CCLayerColor *backgrouScut = CCLayerColor::create(ccc4(255,0,0,255));
    addChild(backgrouScut, -10);
}
...
void SpriteProgressToRadialMidpointChanged::onEnter()
{
    ...
    /**
   *  Our image on the left should be a radial progress iScuticator, clockwise
   */
    ...
    /**
   *  Our image on the left should be a radial progress iScuticator, counter clockwise
   */
    CCProgressTimer *right = CCProgressTimer::create(CCSprite::create(s_pPathBlock));
    right->setType(kCCProgressTimerTypeRadial);
...
//------------------------------------------------------------------
//
// SpriteProgressBarTintAScutFade
//
//------------------------------------------------------------------
void SpriteProgressBarTintAScutFade::onEnter()
{
    SpriteDemo::onEnter();
    ...
    right->addChild(CCLabelTTF::create("Tint aScut Fade", "Marker Felt", 20.0f));
}

std::string SpriteProgressBarTintAScutFade::subtitle()
{
    return "ProgressTo Bar Mid";
}
