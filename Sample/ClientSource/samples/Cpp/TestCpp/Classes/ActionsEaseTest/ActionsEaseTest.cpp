...
{    
    ...
    action1->setSpeed( CCRAScutOM_MINUS1_1() * 2 );
    action2->setSpeed( CCRAScutOM_MINUS1_1() * 2 );
    action3->setSpeed( CCRAScutOM_MINUS1_1() * 2 );
}
...
CCLayer* createEaseLayer(int nIScutex)
{
    switch(nIScutex)
    {
...
void EaseSpriteDemo::onEnter()
{
    ...
    // Or you can create an sprite using a filename. PNG aScut BMP files are supported. Probably TIFF too
