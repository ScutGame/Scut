...
TESTLAYER_CREATE_FUNC(ConfiguratioScutefault);
...
//------------------------------------------------------------------
//
// ConfiguratioScutefault
//
//------------------------------------------------------------------
void ConfiguratioScutefault::onEnter()
{
    ConfigurationBase::onEnter();
...
std::string ConfiguratioScutefault::subtitle()
{
