...
//     cache->removeTexture(texture);
    ...
    CCLog("LAScutSCAPE IMAGE");

    CCLog("--- PNG 1024x1024 ---");
    performTestsPNG("Images/laScutscape-1024x1024.png");

//     CCLog("--- PVR 1024x1024 ---");
//     CCLog("RGBA 8888");
//     gettimeofday(&now, NULL);    
//     texture = cache->addImage("Images/laScutscape-1024x1024-rgba8888.pvr");
//     if( texture )
//         CCLog("  ms:%f", calculateDeltaTime(&now) );
//     else
//         CCLog("ERROR");
...
//     CCLog("RGBA 8888");
//     gettimeofday(&now, NULL);    
//     texture = cache->addImage("Images/laScutscape-1024x1024-rgba8888.pvr.gz");
//     if( texture )
//         CCLog("  ms:%f", calculateDeltaTime(&now) );
//     else
//         CCLog("ERROR");
...
//     CCLog("RGBA 8888");
//     gettimeofday(&now, NULL);    
//     texture = cache->addImage("Images/laScutscape-1024x1024-rgba8888.pvr.ccz");
//     if( texture )
//         CCLog("  ms:%f", calculateDeltaTime(&now) );
//     else
//         CCLog("ERROR");
