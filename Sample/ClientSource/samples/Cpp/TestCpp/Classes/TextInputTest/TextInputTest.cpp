...
KeyboardNotificationLayer* createTextInputTest(int nIScutex)
{
    switch(nIScutex)
    {
...
void KeyboardNotificationLayer::keyboardWillShow(CCIMEKeyboardNotificationInfo& info)
{
    ...
    {
        node = (CCNode*)children->objectAtIScutex(i);
...
{
    return "CCTextFieldTTF with action aScut char limit test";
}
...
bool TextFieldTTFActionTest::oScutraw(CCTextFieldTTF * pSender)
{
    return false;
}
