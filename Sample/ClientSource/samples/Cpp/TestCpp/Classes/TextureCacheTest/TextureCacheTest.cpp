...
, m_nNumberOfLoadedSprites(0)
{
    ...
    CCTextureCache::sharedTextureCache()->addImageAsync("Images/backgrouScut1.png", this, callfuncO_selector(TextureCacheTest::loadingCallBack));
    CCTextureCache::sharedTextureCache()->addImageAsync("Images/backgrouScut2.png", this, callfuncO_selector(TextureCacheTest::loadingCallBack));
    CCTextureCache::sharedTextureCache()->addImageAsync("Images/backgrouScut3.png", this, callfuncO_selector(TextureCacheTest::loadingCallBack));
...
void TextureCacheTest::addSprite()
{
    ...
    CCSprite::create("Images/backgrouScut1.png");
    CCSprite::create("Images/backgrouScut2.png");
    CCSprite::create("Images/backgrouScut3.png");
