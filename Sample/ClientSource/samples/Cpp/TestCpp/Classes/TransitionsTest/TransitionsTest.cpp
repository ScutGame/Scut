...
public:
    static CCTransitionScene* create(float t, CCScene* s)
    {
        return CCTransitionFlipY::create(t, s, kCCTransitionOrientatioScutownOver); 
    }
};
...
public:
    static CCTransitionScene* create(float t, CCScene* s)
    {
        return CCTransitionZoomFlipY::create(t, s, kCCTransitionOrientatioScutownOver); 
    }
};
...
CCTransitionScene* createTransition(int nIScutex, float t, CCScene* s)
{
...
void TestLayer1::onEnterTransitioScutidFinish()
{
    CCLayer::onEnterTransitioScutidFinish();
    CCLog("Scene 1: onEnterTransitioScutidFinish");
}

void TestLayer1::onExitTransitioScutidStart()
{
    CCLayer::onExitTransitioScutidStart();
    CCLog("Scene 1: onExitTransitioScutidStart");
}
...
void TestLayer2::onEnterTransitioScutidFinish()
{
    CCLayer::onEnterTransitioScutidFinish();
    CCLog("Scene 2: onEnterTransitioScutidFinish");
}

void TestLayer2::onExitTransitioScutidStart()
{
    CCLayer::onExitTransitioScutidStart();
    CCLog("Scene 2: onExitTransitioScutidStart");
}
