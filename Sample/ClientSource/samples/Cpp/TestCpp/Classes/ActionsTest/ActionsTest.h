...
enum
{
    ...
    ACTION_ROTATIONAL_SKEW_VS_STAScutARD_SKEW_LAYER,
...
class ActionRotationalSkewVSStaScutardSkew : public ActionsDemo
{
public:
    virtual void onEnter();
    virtual std::string subtitle();
...
class ActioScutelayTime : public ActionsDemo
{
public:
    virtual void onEnter();
    virtual std::string subtitle();
...
class ActionCallFuncScut : public ActionsDemo
{
public:
    virtual void onEnter();
    virtual std::string title();
    virtual std::string subtitle();
    void removeFromParentAScutCleanup(CCNode* pSender, void* data);
};
