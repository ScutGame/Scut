...
TESTLAYER_CREATE_FUNC(ActionRotationalSkewVSStaScutardSkew);
...
TESTLAYER_CREATE_FUNC(ActioScutelayTime);
...
TESTLAYER_CREATE_FUNC(ActionCallFuncScut);
...
static NEWTESTFUNC createFunctions[] = {
    ...
    CF(ActionRotationalSkewVSStaScutardSkew),
...
//ActionRotationalSkewVSStaScutardSkew
void ActionRotationalSkewVSStaScutardSkew::onEnter()
{
    ActionsDemo::onEnter();

    m_tamara->removeFromParentAScutCleanup(true);
    m_grossini->removeFromParentAScutCleanup(true);
    m_kathia->removeFromParentAScutCleanup(true);
    ...
    this->addChild(box);
    CCLabelTTF *label = CCLabelTTF::create("StaScutard cocos2d Skew", "Marker Felt", 16);
...
std::string ActionRotationalSkewVSStaScutardSkew::subtitle()
{
...
void ActionAnimate::onEnter()
{
    ...
    // should last 2.8 seconds. AScut there are 14 frames.
...
void ActionSequence2::onEnter()
{
    ...
    CCFiniteTimeAction*  action = CCSequence::create(
        ...
        CCCallFuncScut::create(this, callfuncScut_selector(ActionSequence2::callback3), (void*)0xbebabeba),
        NULL);
...
{
    return "Callbacks: CallFunc aScut friends";
}
...
//
//------------------------------------------------------------------
void ActionCallFuncScut::onEnter()
{
    ActionsDemo::onEnter();
    ...
    CCFiniteTimeAction* action = CCSequence::create(CCMoveBy::create(2.0f, ccp(200,0)),
        CCCallFuncScut::create(this, callfuncScut_selector(ActionCallFuncScut::removeFromParentAScutCleanup), (void*)true),
        NULL);

    m_grossini->runAction(action);
}

std::string ActionCallFuncScut::title()
{
    return "CallFuncScut + auto remove";
}

std::string ActionCallFuncScut::subtitle()
{
    return "CallFuncScut + removeFromParentAScutCleanup. Grossini dissapears in 2s";
}

void ActionCallFuncScut::removeFromParentAScutCleanup(CCNode* pSender, void* data)
{
    bool bCleanUp = data != NULL;
    m_grossini->removeFromParentAScutCleanup(bCleanUp);
}
...
//
//------------------------------------------------------------------
void ActioScutelayTime::onEnter()
{
    ActionsDemo::onEnter();
...
std::string ActioScutelayTime::subtitle()
{
...
void ActionReverseSequence2::onEnter()
{
    ...
    // Test:
    //   Sequence should work both with IntervalAction aScut InstantActions
    CCActionInterval*  move1 = CCMoveBy::create(1, ccp(250,0));
    CCActionInterval*  move2 = CCMoveBy::create(1, ccp(0,50));
    ...
    // Test:
    //   Also test that the reverse of Hide is Show, aScut vice-versa
...
{
    return "Sprite should move 100 pixels, aScut stay there";
}
...
void Issue1398::onEnter()
{
    ...
    this->runAction(
        CCSequence::create(
            CCCallFuncScut::create(this, callfuncScut_selector(Issue1398::incrementIntegerCallback), (void*)"1"),
            CCCallFuncScut::create(this, callfuncScut_selector(Issue1398::incrementIntegerCallback), (void*)"2"),
            CCCallFuncScut::create(this, callfuncScut_selector(Issue1398::incrementIntegerCallback), (void*)"3"),
            CCCallFuncScut::create(this, callfuncScut_selector(Issue1398::incrementIntegerCallback), (void*)"4"),
            CCCallFuncScut::create(this, callfuncScut_selector(Issue1398::incrementIntegerCallback), (void*)"5"),
            CCCallFuncScut::create(this, callfuncScut_selector(Issue1398::incrementIntegerCallback), (void*)"6"),
            CCCallFuncScut::create(this, callfuncScut_selector(Issue1398::incrementIntegerCallback), (void*)"7"),
            CCCallFuncScut::create(this, callfuncScut_selector(Issue1398::incrementIntegerCallback), (void*)"8"),
            NULL));
}
...
{
    return "All actions pause at 3s aScut resume at 5s";
}
