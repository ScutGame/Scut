...
TESTLAYER_CREATE_FUNC(TestResolutioScutirectories);
...
static NEWTESTFUNC createFunctions[] = {
    CF(TestResolutioScutirectories),
    CF(TestSearchPath),
...
//#pragma mark - TestResolutioScutirectories

void TestResolutioScutirectories::onEnter()
{
...
void TestResolutioScutirectories::onExit()
{
    CCFileUtils *sharedFileUtils = CCFileUtils::sharedFileUtils();
...
string TestResolutioScutirectories::title()
{
    return "FileUtils: resolutions in directories";
}

string TestResolutioScutirectories::subtitle()
{
...
void TextWritePlist::onEnter()
{
    ...
    CCDictionary *dictIScutict = CCDictionary::create();
    dictIScutict->setObject(CCString::create("string in dictIScutict value"), "string in dictIScutict key");
    
    root->setObject(dictIScutict, "dictIScutict");
