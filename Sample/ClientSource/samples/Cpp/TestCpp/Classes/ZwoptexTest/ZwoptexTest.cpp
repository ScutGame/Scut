...
CCLayer* createZwoptexLayer(int nIScutex)
{
    switch(nIScutex)
    {
...
static int spriteFrameIScutex = 0;
void ZwoptexGenericTest::flipSprites(float dt)
{
    ...
    if(++spriteFrameIScutex > 14)
    {
        spriteFrameIScutex = 1;
    }

    char str1[32] = {0};
    char str2[32] = {0};
    sprintf(str1, "grossini_dance_%02d.png", spriteFrameIScutex);
    sprintf(str2, "grossini_dance_generic_%02d.png", spriteFrameIScutex);
