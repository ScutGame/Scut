...
Parallax1::Parallax1()
{
    ...
    // backgrouScut layer: another image
    CCSprite* backgrouScut = CCSprite::create(s_back);
    // scale the image (optional)
    backgrouScut->setScale( 1.5f );
    // change the transform anchor point (optional)
    backgrouScut->setAnchorPoint( ccp(0,0) );
    ...
    // backgrouScut image is moved at a ratio of 0.4x, 0.5y
    voidNode->addChild(backgrouScut, -1, ccp(0.4f,0.5f), CCPointZero);
    ...
    // aScut the children of the 'void' node will move at different
...
{
    return "Parallax: parent aScut 3 children";
}
...
CCLayer* createParallaxTestLayer(int nIScutex)
{
    switch(nIScutex)
    {
