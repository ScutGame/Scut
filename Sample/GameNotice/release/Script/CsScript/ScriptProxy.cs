...
namespace Game.Script
{
    public class ScriptProxy
    {
        ...
        [LuaMethod("GetNoticeCache")]
        public object GetNoticeCache(int pageIndex, int pageSize)
        {
            var noticeList = new ShareCacheStruct<Notice>().FindAll();
            ...
            int pageCount;
            int recordCount;
            noticeList = MathUtils.GetPaging<Notice>(noticeList, pageIndex, pageSize, out pageCount, out recordCount);
            return new object[] { pageCount, noticeList };
        }
    }
}