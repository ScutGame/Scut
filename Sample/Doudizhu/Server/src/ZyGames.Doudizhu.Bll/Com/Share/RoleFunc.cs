...
namespace ZyGames.Doudizhu.Bll.Com.Share
{
    ...
    public class RoleFunc
    {
        ...
        public bool VerifyRange(string nickName, out string msg)
        {
            ...
            {
                msg = string.Format(LanguageManager.GetLang().St1005_NickNameOutRange, minLength, maxLength);
                return true;
            }
            return false;
        }
        ...
        public bool VerifyKeyword(string nickName, out string msg)
        {
            ...
            {
                msg = LanguageManager.GetLang().St1005_NickNameExistKeyword;
                return true;
            }
            return false;
        }
        ...
        public bool IsExistNickName(string nickName, out string msg)
        {
            ...
            if (list.Count > 0)
            {
                msg = LanguageManager.GetLang().St1005_NickNameExist;
                return true;
            }
            return false;
        }
