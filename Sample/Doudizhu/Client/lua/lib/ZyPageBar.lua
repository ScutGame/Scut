...
--
function ZyPageBar:setIsVisible(visible)
	self.mLayerBar:setIsVisible(visible)
end
--
-----------------------------------------------------私有接口----------------------------------
--
function ZyPageBar:initBar()
	...
	for i = 1, nPage do
		button, item = UIHelper.Button(P("button/checkbtnnomral.png"), P("button/checkbtnclick.png"), "ZyPageBarItemPageHandler", "", kCCTextAlignmentCenter, FONT_SM_SIZE, nil, i, i == nc)
