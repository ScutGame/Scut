...
GUIDEINFO[1001]={
	...
	[1] = "你好！我是《口袋天界》的新手引导者，如果你对这个世界的一些情况比较熟悉，可以选择跳过我的引导，直接开始冒险之旅！",
	[2] = "确认跳过新手引导？",
	
	[3] = "恶魔克鲁斯的黑暗统治使得亚鲁尼斯所有生灵走向毁灭。现在你需要证明自己拥有拯救这片大陆的力量。",
	[4] = "你需要进入梦幻森林1杀死1只猫妖来证明自己的力量。",
	[0] = "恭喜您完成了口袋的首次战斗体验，获得%s。你已经证明了自己的力量，副本挑战可以获得荣誉，金币和各种装备，这是提高实力的主要途径。",
}

GUIDEINFO[1002]={
	[1] = "一个人的力量终究有限，你需要去酒馆招募更多志同道合的伙伴一起战斗！",
}
...
GUIDEINFO[1005]={
	[1] = "敌人越来越强大，你需要更快的增强自己的实力！",	
	[0] = "恭喜您获得%s,宝剑配英雄，回到主界面，去给佣兵装备上刚获得的武器！",	
}

GUIDEINFO[1006]={
	[0] = "恭喜您获得%s,宝剑配英雄，回到主界面，去给佣兵装备上刚获得的武器！",
	[1] = "这把武器将会使你的实力更强上一分，快点把武器装备上吧！",
}

GUIDEINFO[1007]={
	[1] = "装备上武器后，是否感觉自己的实力更加强劲了！一把好的武器需要不断的锻造才会更加锋利，现在你需要强化自己的第一把武器！",
}

GUIDEINFO[1008]={
	[1] = "实力又增加了一分，想必现在再遇到敌人能够更加轻松应对！",
}
...
GUIDEINFO[1010]={
	[1] = "佣兵是会长不可缺少的力量，为此必须时刻对其进行升级才能保证佣兵的实力。现在请会长进入佣兵升级界面进行佣兵升级。",
}



GUIDEINFO[1011]={
	[1] = "你已经基本掌握了自己的力量，现在是最后考验你的时候，前往神秘洞穴3击败那里的半兽人！",
}
...
GUIDEINFO[1013]={
	[0] ="恭喜你通过了最终的试炼，获得%s。快打开背包仔细瞧瞧吧，有惊喜哦！",
}
