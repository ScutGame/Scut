            ...
            titleIndex=titleIndex+1
	       		...
	       		listItem:setOpacity(0)
					...
					Btn:selected();
	              	...
	              	Btn:registerScriptHandler(function () gZytableHandler(Btn._menuItem) end); 
...
function ZyTabBar:setEnabled(isEnable)
...
function ZyTabBar:setVisible(isEnable)

	for key, value in pairs(self._menuItems) do
            value:setVisible(isEnable)
	end
