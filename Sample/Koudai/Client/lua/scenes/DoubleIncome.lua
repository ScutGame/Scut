...
module("DoubleIncome", package.seeall)
...
function init(mScene,Flayer,table)
	...
	-- 注册触屏事件
	g_layer.__CCTouchDelegate__:registerScriptTouchHandler(CCTOUCHBEGAN, "DoubleIncome.touchBegan")
	g_layer.__CCTouchDelegate__:registerScriptTouchHandler(CCTOUCHMOVED, "DoubleIncome.touchMove")
	g_layer.__CCTouchDelegate__:registerScriptTouchHandler(CCTOUCHENDED, "DoubleIncome.touchEnd")
	...
	local  BgImg = CCSprite:create(P("activeBg/list_1159.jpg"))
