...
function submit()
    ...
    local button2 = ZyButton:new("button/button_1011.png", "button/button_1012.png",nil,commonString.IDS_OK)
    ...
    local button3 = ZyButton:new("button/button_1011.png", "button/button_1012.png",nil,commonString.IDS_CANCLE)
...
function init()
    ...
    local button2 = ZyButton:new("button/button_1011.png", "button/button_1012.png",nil,commonString.IDS_SUBMIT)
...
function netCallback(pZyScene, lpExternalData)
    ...
    if actionID==1001 then
        ...
        if table then
            bgLayer= UIHelper.createUIBg(nil,nil,ccc3(255,255,255),nil,true)
            mScene:addChild(bgLayer)
            local closeBtn=ZyButton:new(Image.image_exit, Image.image_exit);
