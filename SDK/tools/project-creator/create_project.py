...
def dumpUsage():
    ...
    print "  -language  PROGRAMING_LANGUAGE   Major programing lanauge you want to used, should be [scutlua]"
    print ""
    print "Sample 1: ./create_project.py -project MyGame -package com.MyCompany.AwesomeGame"
    print "Sample 2: ./create_project.py -project MyGame -package com.MyCompany.AwesomeGame -language scutlua"
    print ""
...
def checkParams(context):
    ...
    if ("quick" == context["language"]):
        context["src_project_name"] = "HelloLua"
        context["src_package_name"] = "org.cocos2dx.hellolua"
        context["src_project_path"] = os.getcwd() + "/../../template/multi-platform-quick"
        platforms_list = ["ios",
                          "android",
                          "win32",
                          "blackberry",
