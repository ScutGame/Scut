...
OutputBaseFilename=SCUTServer_Setup_x86_{#MyAppVersion}
...
Source: "Redis\x86\run.bat"; DestDir: "{app}\Redis\x86"; Flags: ignoreversion           
...
Name: "{group}\Redis Server"; Filename: "{app}\redis\x86\run.bat"        
